namespace Quantum {
  ...
  public static class QuantumUnityExtensions {
    ...
    public static T FindObjectOfType<T>() where T : Object {
      return (T)FindObjectOfType(typeof(T), FindObjectsInactive.Exclude);
    }
    ...
    public static T FindObjectOfType<T>(FindObjectsInactive findObjectsInactive) where T : Object {
      return (T)FindObjectOfType(typeof(T), findObjectsInactive);
    }
    ...
    public static Object FindObjectOfType(System.Type type, FindObjectsInactive findObjectsInactive) {
      return Object.FindObjectOfType(type
#if UNITY_2020_1_OR_NEWER
        , findObjectsInactive == FindObjectsInactive.Include
#endif
